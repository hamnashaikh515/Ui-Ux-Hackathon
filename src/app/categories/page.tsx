        ...
        <section className="popular w-full flex flex-col gap-4">
          <div className="sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { title: 'Nissan GT - R', image: '/car3.png', desc: 'Luxury' },
              { title: 'Rolls-Royce', image: '/car (3).png', desc: 'Sport' },
              { title: 'All New Rush', image: '/car5.png', desc: 'Luxury' },
              { title: 'CR - V', image: '/car6.png', desc: 'Luxury' },
              { title: 'ALLNEW TERIOS', image: '/car7.png', desc: 'SUV' },
              { title: 'MGZX Exclusive', image: '/car8.png', desc: 'Luxury' },
              { title: 'NEW MGZS', image: '/car9.png', desc: 'SUV' },
            ].map((car, index) => (
          ...
          {showMore && (
            <div className="sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { title: 'MG ZX Exclusive', image: '/car8.png', desc: 'SUV' },
                { title: 'NEW MG ZS', image: '/car9.png', desc: 'Sedan' },
                { title: 'New MG ZX Excite', image: '/car8.png', desc: 'Sport' },
                { title: 'NEW MG ZS', image: '/car9.png', desc: 'Sedan' },
              ].map((car, index) => (
                <Card key={index} className="w-full max-w-[304px] mx-auto h-auto flex flex-col justify-between">
                  <CardHeader>
