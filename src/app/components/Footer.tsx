        ...
        <div className="lists flex flex-wrap gap-6 justify-center lg:justify-between w-full lg:w-auto lg:mr-10">
          <div className="about">
            <ul className="flex flex-col gap-1">
              <li className="font-semibold text-lg"><h1>About</h1></li>
              <li>How it works</li>
              <li>Featured</li>
              <li>Partnership</li>
          ...
          <div className="community">
            <ul className="flex flex-col gap-1">
              <li className="font-semibold text-lg"><h1>Community</h1></li>
              <li>Events</li>
              <li>Blog</li>
              <li>Podcast</li>
          ...
          <div className="socials">
            <ul className="flex flex-col gap-1">
              <li className="font-semibold text-lg"><h1>Socials</h1></li>
              <li>Discord</li>
              <li>Instagram</li>
              <li>Facebook</li>
              <li>Twitter</li>
